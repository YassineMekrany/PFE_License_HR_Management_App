...
if (count($Allmessage) > 5) {
?>
    <a class="btn btn-light" href="index.php?action=AfficherPlusMsg&receiver_type=<?= $receiver_type ?>&receiver_id=<?= $receiver_id ?>">Afficher tous les messages...</a> 
<?php 
}
?><br>
