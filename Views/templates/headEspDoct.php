...
include_once("Models/AnnonceManager.php");
?>
        ...
        <ul class="navbar-nav bg-gradient-primary  sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span>Ajouter Production</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Ajouter Production:</h6>
                        <a class="dropdown-item" href="index.php?action=AjouterActivite">Ajouter Activité</a>
						<a class="dropdown-item" href="index.php?action=AjouterPublication">Ajouter Publication</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="index.php?action=MonCv">
                <span>Mon CV</span></a>
            </li>
            <?php if(isReinscriptionActivated()){ ?>
            <li class="nav-item">
                <a class="nav-link" href="index.php?action=Reinscription">
                <span>Réinscription</span></a>
            </li><?php } ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <a class="btn btn-light" href="index.php?action=MesNotifications&receiver_type=doctorants&receiver_id=<?= $_SESSION["id"] ?>"><i style="font-size: 2em;" class="bi bi-bell-fill"><span class="badge badge-danger badge-counter"><?php if(nbrNotificationsNonLus($_SESSION["id"],"doctorants") == 0) echo ""; else echo nbrNotificationsNonLus($_SESSION["id"],"doctorants");   ?></span></i></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-light" href="index.php?action=RecevoirMsg&receiver_type=doctorants&receiver_id=<?= $_SESSION["id"] ?>"><i style="font-size: 2em;" class="bi bi-envelope-fill"><span class="badge badge-danger badge-counter"><?php if(nbrMsgNonLus($_SESSION["id"],"doctorants") == 0) echo ""; else echo nbrMsgNonLus($_SESSION["id"],"doctorants"); ?></span></i></a>
						...
						<li class="nav-item active">
							...
							echo "Non Connecté";}
								...
								<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									<a class="dropdown-item" href="index.php?action=ChangerPasswordDoct"><i class="fa fa-wrench" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Changer Mot de Passe</a>
									<a class="dropdown-item" href="index.php?action=DeconnexionDoct"><i class="fa fa-power-off" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; Déconnexion</a>
								</ul>
								</div><?php }?>
						</li>
