...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="index.php?action=EspaceProf">
                <i class="fa fa-users fa-lg" aria-hidden="true"></i>
                    <span>Mes Doctorants</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="index.php?action=AjouterOrganisation">
                <i class="bi bi-plus-circle"></i>
                    <span>Ajouter Organisation</span></a>
            </li>
            <!-- Divider -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <a class="btn btn-light" href="index.php?action=MesNotifications&receiver_type=professeurs&receiver_id=<?= $_SESSION["id"] ?>"><i style="font-size: 2em;" class="bi bi-bell-fill"><span class="badge badge-danger badge-counter"><?php if(nbrNotificationsNonLus($_SESSION["id"],"professeurs") == 0) echo ""; else echo nbrNotificationsNonLus($_SESSION["id"],"professeurs");   ?></span></i></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-light" href="index.php?action=RecevoirMsg&receiver_type=professeurs&receiver_id=<?= $_SESSION["id"] ?>"><i style="font-size: 2em;" class="bi bi-envelope-fill"><span class="badge badge-danger badge-counter"><?php if(nbrMsgNonLus($_SESSION["id"],"professeurs") == 0) echo ""; else echo nbrMsgNonLus($_SESSION["id"],"professeurs"); ?></span></i></a>
                    
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-light" href="index.php?action=MesDoctAppr&id=<?= $_SESSION["id"] ?>"><i style="font-size: 2em;" class="bi-people-fill"><span class="badge badge-danger badge-counter"><?php if(count(getDoctApprParEncadrant($_SESSION["id"])) == 0) echo ""; else echo count(getDoctApprParEncadrant($_SESSION["id"])); ?></span></i></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        echo "Non Connecté";}
                          ...
                          <a class="dropdown-item" href="index.php?action=ChangerPasswordProf"><i class="fa fa-wrench" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Changer Mot de Passe</a>
                                <a class="dropdown-item" href="index.php?action=DeconnexionProf"><i class="fa fa-power-off" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; Déconnexion</a>
                              </ul>
                            </div><?php }?>
                          </li>
